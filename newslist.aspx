<%@ Page Title="" Language="C#" MasterPageFile="~/English.master" AutoEventWireup="true" CodeFile="newslist.aspx.cs" Inherits="newslist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<h1>News</h1>
          ...
          <asp:Repeater runat="server" ID="Haberlerim" DataSourceID="SqlDataSource1">
              <ItemTemplate>
                    <a href="/news/<%# Eval("id") %>">
                    <b><%# Eval("haber_tarihi") %><b> -<%# Eval("haber_basligi_en") %></b></b></a>
              </ItemTemplate>
          </asp:Repeater>
