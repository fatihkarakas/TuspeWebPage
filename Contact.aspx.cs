...
public partial class Contact : System.Web.UI.Page
{
    ...
    protected void Gonder_Click(object sender, EventArgs e)
    {
        ...
        {
            Mesaj.Visible = true;
            Mesaj.Text = "Error !! : Form fields can not be  empty";
            return;
        }
        if (TextBox1.Text == "" || TextBox1.Text.Length < 5)
        {
            Mesaj.Visible = true;
            Mesaj.Text = "Error !! : Form (Message) fields can not be  empty";
            TextBox1.Focus();
            return;
        }
        ...
        {
            Mesaj.Visible = true;
            Mesaj.Text = "Error !! : Captcha code is incorrect";
            return;
        }
       ...
       if(Yd.Iletisim_Ekle(AdSoyad.Text, email.Text, Telefon.Text, TextBox1.Text, IpAdres()))
        {
            Mesaj.Visible = true;
            Mesaj.Text = "Your message han been send";
        ...
        {
            Mesaj.Visible = true;
            Mesaj.Text = "Send Error !! :" + Yd.islemhatamesaj;
        }
    }
